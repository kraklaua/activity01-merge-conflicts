...
**Response**: The passing movies have a higher gross to budget ratio.
...
**Response**: notalk has the highest budget and domestic and international gross.  ok has the smallest budget and domestic and international gross.
...
**Response**: All categories have a similar range in ROI less than 10 but ok is the only one that passed the bechdel test.
